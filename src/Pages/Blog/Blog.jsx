        ...
        <div className="mt-10">
            <div className="collapse bg-base-200">
                ...
                <div className="collapse-content bg-primary text-primary-content peer-checked:bg-secondary peer-checked:text-secondary-content">
                    <p> <span>Access Token :</span> An access token is a credential granted to a user after authentication. It is a string used to access protected resources, such as APIs.</p>
                    <p> <span>Refresh Token :</span> A refresh token is a long-lived credential that is issued during authentication. It is used to obtain a new access token without requiring the user to re-authenticate. Refresh tokens have a longer expiration period and are securely stored on the client-side. They enable seamless interactions and maintain user sessions.</p>
                    <p><span>Storage on the Client-side : </span>
                        Access tokens are stored in memory or short-lived mechanisms like cookies or local storage for easy retrieval. Refresh tokens, being more sensitive, are securely stored server-side or in secure storage mechanisms like encrypted storage or HTTP-only cookies.</p>
                </div>
            </div>
            <div className="collapse bg-base-200">
                <input type="checkbox" className="peer" />
